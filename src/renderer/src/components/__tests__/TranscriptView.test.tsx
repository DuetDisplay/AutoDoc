...
describe('TranscriptView', () => {
  ...
  it('does not over-merge long same-speaker runs into a massive paragraph', () => {
    const segments: Transcript[] = [
      { id: 'seg-0', meetingId: 'm1', speaker: 'Speaker', text: 'First sentence with enough content to matter.', startMs: 0, endMs: 3000, confidence: -1 },
      { id: 'seg-1', meetingId: 'm1', speaker: 'Speaker', text: 'Second sentence that would previously get folded into the same paragraph.', startMs: 3200, endMs: 6200, confidence: -1 },
      { id: 'seg-2', meetingId: 'm1', speaker: 'Speaker', text: 'Third sentence should stay separate once the group gets too large.', startMs: 6400, endMs: 9400, confidence: -1 },
      { id: 'seg-3', meetingId: 'm1', speaker: 'Speaker', text: 'Fourth sentence definitely needs its own row.', startMs: 9600, endMs: 12600, confidence: -1 },
    ]
  ...
  it('merges short same-speaker fragments into a sentence-like block', () => {
    const segments: Transcript[] = [
      { id: 'seg-0', meetingId: 'm1', speaker: 'Speaker', text: 'quite confident that these charts always show', startMs: 0, endMs: 2500, confidence: -1 },
      { id: 'seg-1', meetingId: 'm1', speaker: 'Speaker', text: 'accurate results, so I want to look', startMs: 2600, endMs: 5200, confidence: -1 },
      { id: 'seg-2', meetingId: 'm1', speaker: 'Speaker', text: 'into this a bit more.', startMs: 5300, endMs: 7600, confidence: -1 },
      { id: 'seg-3', meetingId: 'm1', speaker: 'Speaker', text: 'Okay, so what your concern is is that we are', startMs: 7700, endMs: 10200, confidence: -1 },
      { id: 'seg-4', meetingId: 'm1', speaker: 'Speaker', text: 'unfairly penalizing 4.x when the', startMs: 10300, endMs: 12600, confidence: -1 },
      { id: 'seg-5', meetingId: 'm1', speaker: 'Speaker', text: 'event applies to both 4.x and 4.x.', startMs: 12700, endMs: 15300, confidence: -1 },
    ]
